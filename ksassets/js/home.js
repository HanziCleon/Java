...
var MAC={
    ...
    'UserAgent' : function(){
        ...
        return {
            ...
            'weixin': ua.indexOf('MicroMessenger') > -1 //a ua.match(/MicroMessenger/i) == "micromessenger",
        };
    }(),
    'Copy': function(s){
        ...
        try{
            ...
            if(window.netscape){
                try{netscape.security.PrivilegeManager.enablePrivilege("UniversalXPConnect");}
                    ...
                    MAC.Pop.Msg(150, 40, 'This operation is blocked by the browser. Please set it manually.', 1000); 
                  }                  
    ...
    'Fav': function(u,s){
        try{ window.external.addFavorite(u, s);}
            ...
            try {
                ...
                MAC.Pop.Msg(150, 40, 'Error adding to favorites. Please use Ctrl+D to add manually.', 1000);
              }
    ...
    'Verify': {
        ...
        'Show':function(){
            return '<img class="mac_verify_img" src="' + maccms.path + '/index.php/verify/index.html?" title="Can not see clearly? Change one!">';
        }
    },
    'PageGo':{
        'Init':function() {
    ...
    'Score': {
        'Init':function(){
            ...
            MAC.Ajax(maccms.path+'/index.php/ajax/score?mid='+ $('.mac_score').attr('data-mid') +'&id=' +$('.mac_score').attr('data-id'),'post','json','',function(r){
                ...
                $(".mac_score").html('Score loading failed');
            });
            ...
            $('.mac_star').raty({
                ...
                click: function(score, evt) {
                    ...
                    MAC.Ajax(maccms.path+'/index.php/ajax/score?mid='+$('.mac_star').attr('data-mid')+'&id='+$('.mac_star').attr('data-id')+'&score='+(score*2),'get','json','',function(r){
                        ...
                        $('.star_box').attr('title', 'Network error');
    ...
    'Gbook':{
        ...
        'Show':function($page){
            MAC.Ajax(maccms.path+'/index.php/gbook/index?page='+$page,'post','json','',function(r){
                ...
                $(".mac_gbook_box").html('Comment loading failed, please refresh...');

            });
        },
        'Submit':function(){
            if($(".gbook_content").val() == ''){
                MAC.Pop.Msg(100, 20, 'Please enter your comment!', 1000);
        ...
        'Report':function(name,id){
            MAC.Pop.Show(400, 300, 'Data error', maccms.path + '/index.php/gbook/report.html?id=' + id + '&name=' + encodeURIComponent(name), function(r)
{
    ...
    'History': {
        ...
        'Init':function(){
            ...
            html += '<dt><a target="_self" href="javascript:void(0)" onclick="MAC.History.Clear();">Clear</a></dt>';
            ...
            if(jsondata.length > 0){
                ...
                html += '<dd class="hide">No browsing history</dd>';
        ...
        'Clear': function(){
            ...
            $('.mac_history_box').html('<li class="hx_clear">Browsing history has been cleared.</li>');
    ...
    'User':{
        ...
        'Init':function(){
            ...
            if(MAC.Cookie.Get('user_id') !=undefined && MAC.Cookie.Get('user_id')!=''){
                ...
                if($('.mac_user').length >0) {
                    ...
                    html += '<ul class="logged"><li><a target="_blank" href="' + url + '">User Bookmark</a></li><li class="logout"><a class="logoutbt" href="javascript:;" onclick="MAC.User.Logout();" target="_self"><i class="user-logout"></i>Log out</a></li></ul>'
        ...
        'Login':function(){
            ...
            MAC.Pop.Show(400,380,'User Login',maccms.path+'/index.php/user/'+ac,function(r){
        ...
        'BuyPopedom':function(o){
            var $that = $(o);
            if($that.attr("data-id")){
                if (confirm('Do you agree to authorize access to subscription data?')) {
    ...
    'Pop':{
        ...
        'Show':function($w,$h,$title,$url,$callback) {
            ...
            $('body').append('<div class="mac_pop_bg"></div><div class="mac_pop"><div class="pop_top"><h2></h2><span class="pop_close">close</span></div><div class="pop_content"></div></div>');
            ...
            MAC.Ajax($url,'post','json','',function(r){
                ...
                $(".pop_content").html('Loading failed, please refresh...');
            });
    ...
    'Comment':{
        ...
        'Show':function($page){
            if($(".mac_comment").length>0){
                MAC.Ajax(maccms.path + '/index.php/comment/ajax.html?rid='+$('.mac_comment').attr('data-id')+'&mid='+ $('.mac_comment').attr('data-mid') +'&page='+$page,'get','json','',function(r){
                    ...
                    $(".mac_comment").html('<a href="javascript:void(0)" onclick="MAC.Comment.Show('+$page+')">Comments are closed...</a>');
                });
            }
        },
        'Reply':function($o){
        ...
        'Submit':function($o){
            ...
            if ($('.mac_comment').attr('data-mid') == '') {
                MAC.Pop.Msg(100, 20, 'Module mid error!', 1000);
                return false;
            }
            if ($('.mac_comment').attr('data-id') == '') {
                MAC.Pop.Msg(100, 20, 'Related id error!', 1000);
                return false;
            }
